...
INSERT [dbo].[Cities] ([ID], [Name]) VALUES (N'00000000-0000-0000-0000-000000000000', N'(unknown)')
GO
INSERT [dbo].[Cities] ([ID], [Name]) VALUES (N'1b5bb889-17d4-4784-ad24-3250b73c8621', N'Duckburg')
GO
INSERT [dbo].[Cities] ([ID], [Name]) VALUES (N'd6d641da-f758-4986-9b06-f61bf0da12f6', N'Taggia')
GO
INSERT [dbo].[People] ([Id], [Name], [CityId], [IsEnabled]) VALUES (N'eee34f94-f9fe-4d70-8514-bf47a598e408', N'Donald Duck', N'1b5bb889-17d4-4784-ad24-3250b73c8621', 1)
GO
INSERT [dbo].[People] ([Id], [Name], [CityId], [IsEnabled]) VALUES (N'54164591-8a76-4749-b626-c43b6fa87987', N'Marco', N'd6d641da-f758-4986-9b06-f61bf0da12f6', 1)
GO
INSERT [dbo].[PhoneNumbers] ([Id], [PersonId], [Type], [Number]) VALUES (N'bb38be0a-ac97-4a48-baca-a006a0c0a2ec', N'54164591-8a76-4749-b626-c43b6fa87987', N'Work', N'42000')
GO
INSERT [dbo].[PhoneNumbers] ([Id], [PersonId], [Type], [Number]) VALUES (N'9be7942f-47c8-4803-8030-beb66b748d3f', N'54164591-8a76-4749-b626-c43b6fa87987', N'Mobile', N'42')
GO

ALTER TABLE [dbo].[Cities] ADD  CONSTRAINT [DF_Cities_ID]  DEFAULT (newsequentialid()) FOR [ID]
GO
...
GO
ALTER TABLE [dbo].[PhoneNumbers] ADD  CONSTRAINT [DF_PhoneNumbers_Id]  DEFAULT (newsequentialid()) FOR [Id]
GO
...
-- USE THE FOLLOWING SCRIPTS TO CONVERT EXISTING TABLES INTO TEMPORAL TABLES
